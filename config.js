...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'M-RIZWAN-MD',
    botOwner: process.env.BOT_OWNER || 'M RIZWAN',
    ownerNumber: process.env.OWNER_NUMBER || '923436259742',
    author: process.env.AUTHOR || 'M RIZWAN',
    packname: process.env.PACKNAME || 'M-RIZWAN-MD',
    ...
    // Links
    channelLink: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029Vb4Jh4wHgZWirfaYva0H',
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/m-rizwan-mods/Rizwan-mdx-bot/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'M RIZWAN',
    // Session
