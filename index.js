...
const phoneNumber = config.pairingNumber || config.ownerNumber || "923436259742";
...
global.botname = config.botName || "M-RIZWAN-MD";
global.themeemoji = "•";
    ...
    try {
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection === "open") {
                ...
                printLog('info', `[ ${config.botName || 'M-RIZWAN-MD'} ]`);
...
async function main() {
    ...
    printLog('info', 'Starting M RIZWAN MD BOT...');
